...
function App() {
  ...
  const mainView =
    viewMode === 'split' ? (
      <SplitView terrainData={terrainData} overlayData={activeOverlay} settings={settings} onCanvasReady={setCanvasElement} />
    ) : (
      <motion.div
      ...
      >
        ...
        >
          <TerrainViewer terrainData={terrainData} overlayData={activeOverlay} settings={settings} onCanvasReady={setCanvasElement} />
        </Suspense>
      </motion.div>
    )
