...
const Scene = memo(function Scene({ terrainData, overlayData, settings }) {
  const { invalidate } = useThree()

  return (
    <>
      <RenderInvalidator deps={[terrainData, overlayData, settings]} />
...
const TerrainViewer = memo(function TerrainViewer({ terrainData, overlayData, settings, onCanvasReady }) {
  return (
    <div className="relative w-full h-full">
      <Canvas shadows frameloop="demand" gl={{ preserveDrawingBuffer: true }}>
        ...
        <Scene terrainData={terrainData} overlayData={overlayData} settings={settings} />
      </Canvas>
      <CompassOverlay />
    </div>
  )
